...
public class RacePartDriver {
	...
	public RacePartDriver(int courseID){
		...
		if(courseID == 1){	//Rコース  左側走行　これで22秒安定
			/*
			sectionList.add(new SectionInfo(0,250.0F,-40.0F,-10.0F,-5.0F,0.5F,100.0F));//GATE1前まで
			sectionList.add(new SectionInfo(1,450.0F,-60.0F,-5.0F,-5.0F,0.5F,100.0F));
			sectionList.add(new SectionInfo(2,700.0F,-100.0F,-10.0F,-10.0F,0.5F,80.0F));
			sectionList.add(new SectionInfo(3,800.0F,-85.0F,-10.0F,-7.0F,0.5F,100.0F));//ラストの直線前まで
