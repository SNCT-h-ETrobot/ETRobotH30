...
public class HSVColorDetector {
	...
	private final float WHITE_BRIGHTNESS = 0.36F;
	...
	private final float UNDER_YELLOW_HUE = 0.125F;//0.14
	private final float UNDER_BLACK_WHITE_HUE = 0.28F;//0.25
	private final float UNDER_GREEN_HUE = 0.35F;//0.32
	private final float UNDER_BLUE_HUE = 0.6F;//0.57
