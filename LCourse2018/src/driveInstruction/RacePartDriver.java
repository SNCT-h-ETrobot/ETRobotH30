...
public class RacePartDriver {
	...
	public RacePartDriver(int courseID){
		...
		if(courseID == 1){	//Rコース  左側走行　これで22.46秒
			...
			sectionList.add(new SectionInfo(1,400.0F,-47.5F,-15.0F,-5.0F,0.5F,100.0F));//カーブGATE1まで
			sectionList.add(new SectionInfo(2,550.0F,-30.0F,-10.0F,-5.0F,0.5F,100.0F));//二つ目のカーブ前まで
			sectionList.add(new SectionInfo(3,900.0F,-250.0F,-5.0F,-5.0F,0.5F,100.0F));
